        ...
        for sample in ace_original:
            ...
            for syntactic_label in sample['stanford-colcc']:
                ...
                dep_dict = {'O': 0, 'punct': 1, 'iobj': 2, 'parataxis': 3, 'auxpass': 4, 'aux': 5, 'conj': 6,
                            ...
                            'cc': 38, 'det': 39, 'nmod:in': 40, 'det:qmod': 41, 'nmod:until': 41, 'nmod:of': 43,
                            'nmod:on': 44,
                            'advcl:as': 45, 'nmod:with': 46, 'nmod:by': 47,
                            'nmod:instead_of': 48, 'nmod:for': 49, 'nmod:to': 50, 'ref': 52, 'nmod:agent': 53,
                            'conj:and': 54,
                            'nmod:like': 55, 'nsubj:xsubj': 56,
                            'nmod:at': 57, 'advcl:if': 58, 'nmod:than': 59, 'conj:or': 60, 'acl:to': 61,
                            'nmod:under': 62,
                            'advcl:to': 63, 'acl:of': 64, 'nmod:from': 65,
                            'nmod:between': 66, 'advcl:for': 67, 'conj:but': 68, 'advcl:in': 69, 'nmod:as': 70,
                            'advcl:because': 71,
                            'advcl:than': 72, 'nmod:after': 73,
                            'nmod:about': 74, 'nmod:over': 75, 'nmod:within': 76, 'advcl:about': 77,
                            'nsubjpass:xsubj': 78,
                            'advcl:while': 79, 'nmod:through': 80,
                            'advcl:into': 81, 'advcl:like': 82, 'nmod:against': 83, 'nmod:out_of': 84,
                            'nmod:across': 85,
                            'acl:for': 86, 'nmod:because_of': 87,
                            'conj:instead': 88, 'acl:in': 89, 'advcl:without': 90, 'nmod:because': 91,
                            'advcl:before': 92,
                            ...
                            'advcl:unless': 102, 'nmod:toward': 103, 'advcl:until': 104, 'advcl:in_order': 105,
                            'acl:on': 106,
                            ...
                            'nmod:except': 116, 'nmod:but': 117, 'nmod:far_from': 118, 'nmod:that': 119,
                            'nmod:near': 120,
                            ...
                            'nmod:beginning': 135, 'advcl:after': 136, 'nmod:past': 137, 'advcl:such': 138,
                            'nmod:vs.': 139,
                            ...
                            'nmod:above': 173, 'nmod:while': 174, 'acl:between': 175, 'nmod:involving': 176,
                            'nmod:towards': 177,
                            'acl:instead_of': 178, 'advcl:over': 179, 'nmod:regarding': 180,
                            'nmod:despite': 181, 'nmod:next_to': 182, 'nmod:as_for': 183, 'nmod:besides': 184,
                            'advcl:toward': 185,
                            'acl:about': 186, 'nmod:concerning': 187, 'advcl:instead_of': 188,
                            'advcl:not': 189, 'conj:x': 190, 'conj:v.': 191, 'nmod:compared_with': 192,
                            'nmod:both': 193,
                            ...
                            'nmod:inside': 229, 'nmod:underneath': 230, 'nmod:via': 231, 'nmod:other': 232,
                            'advcl:although': 233,
                            ...
                            'advcl:under': 246, 'nmod:once': 247, 'nmod:per': 248, 'nmod:on_top_of': 249,
                            'nmod:amid': 250,
                            'acl:without': 251, 'advcl:in_case': 252, 'acl:that': 253, 'nmod:as_to': 254,
                            'advcl:including': 255,
                            'nmod:till': 256, 'acl:as_to': 257, 'advcl:\'s': 258, 'nmod:apart_from': 259,
                            'advcl:near': 260,
                            'nmod:whether': 261, 'conj:not': 262, 'nmod:following': 263, 'acl:except': 264,
                            'nmod:based_on': 265, 'nmod:in_addition_to': 266, 'acl:since': 267, 'advcl:ta': 268,
                            'acl:like': 269,
                            'nmod:de': 270, 'nmod:outside_of': 271, 'advcl:based_on': 272, 'advcl:a.': 273,
                            'nmod:or': 274, 'conj:negcc': 275, 'nmod:due_to': 276, 'advcl:except': 277,
                            'nmod:unlike': 278,
                            'nmod:if': 279, 'acl:with': 280, 'nmod:below': 281, 'advcl:within': 282,
                            'advcl:outside': 283,
                            'advcl:despite': 284,
                ...
                if len(syntactic_label_data[0].split(':')) > 1:
                    ...
                    if syntactic_label_data[0].split(':')[1].startswith('close_by') and syntactic_label_data[0].split(":")[0].startswith('nmod'):
                        ...
                        syntactic_label_data[0] = syntactic_label_data[0].split(':')[0]
                        print("hi")
                    elif syntactic_label_data[0].split(':')[1].startswith('athen') and syntactic_label_data[0].split(":")[0].startswith('advcl'):
                        syntactic_label_data[0] = syntactic_label_data[0].split(':')[0]
                        print("hi")
                    elif syntactic_label_data[0].split(':')[1].startswith('as_of') and syntactic_label_data[0].split(":")[0].startswith('advcl'):
                        print('hi')
                        syntactic_label_data[0] = syntactic_label_data[0].split(':')[0]
